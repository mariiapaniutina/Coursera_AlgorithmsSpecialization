...
$.get( "input.txt", function( data ) {
    ...
    console.log('result with pivot always first', arrFirst.comparisons);
    console.log('result with pivot always last', arrLast.comparisons);
    console.log('result with pivot always middle', arrMiddle.comparisons);
});